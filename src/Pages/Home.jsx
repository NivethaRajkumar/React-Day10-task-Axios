    ...
    <>
      <div className="row row-cols-1  row-cols-md-2 py-2 pb-5 me-0 details  ">
        {details.map((element, index) => {
          return (
            <div key={index}>
              <div className="card card-home col-md-4 col-sm-6 py-1  " style={{ width: "80%", height:"90%"}}>
                <div className="card-header">Name : {element.name} </div>
                <div className="card-body">
                  <p className="card-text">
                    <span className=" details-name">User Name :</span>{" "}
                    {element.username} <br />
                    <span className="  details-email">Email :</span> {element.email}{" "}
                    <br />
                    ...
                    <br />
                    <span className=" details-phone ">Phone :</span> {element.phone}
                    <br />
                    <span className="  details-website ">website :</span> {element.website}
                    <br />
                    <span className="  details-company ">Company Name :</span> {element.company.companyName}
                    <br />
